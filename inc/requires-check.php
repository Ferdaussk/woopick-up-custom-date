...
// For woocommerce
function wpucd_WooCommerce_register_required_plugins() {
	...
	if (wpucd_WooCommerce_addon_install()){
		...
		$bwd_w_plugin_the_notice_is = '<p><b>'.esc_html__('WooPick Up Custom Date').'</b> '.esc_html__('requires WooCommerce to be activated.').'</p>';
		...
		$bwd_w_plugin_the_notice_is = '<p><b>'.esc_html__('WooPick Up Custom Date').'</b> '.esc_html__('requires WooCommerce to be installed and activated.').'</p>';
...
function wpucd_WooCommerce_addon_install(){
